...
//и добавлять их в коллекцию. Из коллекции можно удалять фигу
//ры по индексу, а также выводить на экран уже введенные фигуры с их свойствами. 
